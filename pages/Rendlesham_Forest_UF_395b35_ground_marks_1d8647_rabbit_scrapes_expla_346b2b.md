...
show_ads: true
description: Rabbit diggings offer a simple explanation for why ordinary forest marks could become the centre of a UFO landing claim.
hero_summary: Rabbit diggings offer a simple explanation for why ordinary forest marks could become the centre of a UFO landing claim.
layout: default
permalink: /rabbit-scrapes/
sidebar_expanded_urls:
- /rendlesham-forest/
- /ground-marks/
nav_short_title: Rabbit Scrapes
title: Could Rabbit Scrapes Explain the Landing Site?
title_full: Could Rabbit Scrapes Explain the Landing Site?
display_title_short: Rabbit Scrapes
display_title: Rabbit Scrapes
heading_title: Could Rabbit Scrapes Explain the Landing Site?
page_heading_title: Could Rabbit Scrapes Explain the Landing Site?
source_count: 39
infographic_count: 3
planned_sections:
- What police and forestry witnesses reported
- How animal scrapes can mimic impressions
- Why age and irregularity matter
...
next_link:
  ...
  heading_title: Was the Landing Site Already Contaminated?
header:
  og_image: /assets/images/Rendlesham_Forest_UF_395b35_ground_marks_1d8647_rabbit_scrapes_expla_346b2b-Illustration-1-social.jpg
  preview_image: /assets/images/Rendlesham_Forest_UF_395b35_ground_marks_1d8647_rabbit_scrapes_expla_346b2b-Illustration-1.webp
image: /assets/images/Rendlesham_Forest_UF_395b35_ground_marks_1d8647_rabbit_scrapes_expla_346b2b-Illustration-1-social.jpg
---

## Introduction

One of the simplest explanations for the alleged landing traces at [Rendlesham Forest]({{ 'rendlesham-forest/' | relative_url }}) is that the ground marks were not landing gear impressions at all, but ordinary rabbit scrapes. This explanation matters because the three small depressions became the principal physical evidence for a craft supposedly touching down in the forest. If those marks were already present as natural animal disturbance, the case for a landed object becomes substantially weaker.
...
<img src="{{ "/assets/images/Rendlesham_Forest_UF_395b35_ground_marks_1d8647_rabbit_scrapes_expla_346b2b-Illustration-2-dark.svg" | relative_url }}" alt="Rabbit Scrapes illustration 2" data-theme-src-dark="{{ "/assets/images/Rendlesham_Forest_UF_395b35_ground_marks_1d8647_rabbit_scrapes_expla_346b2b-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Rendlesham_Forest_UF_395b35_ground_marks_1d8647_rabbit_scrapes_expla_346b2b-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## How Animal Scrapes Can Mimic Impressions
...
## Why the Rabbit Explanation Remains Significant
...
<section class="further-reading-section" data-page-toc-exclude aria-labelledby="further-reading-title">
  <div class="fr-section-shell">
    <div class="fr-section-header">
      ...
      <p class="fr-intro">Books and field guides related to Rendlesham Forest UF 395b35 ground marks 1d8647 rabbit scrapes expla 346b2b. Use these as the next step if you want deeper reading beyond the article.</p>
    </div>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Addresses the disputed ground impressions at the site.</p>
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Useful for understanding how mundane causes can be misinterpreted.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Examines competing explanations for the physical traces.</p>
        <div class="fr-book-actions">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Discusses trace cases and ordinary explanations for sightings.</p>
        <div class="fr-book-actions">
